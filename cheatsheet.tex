...
\begin{multicols}{2}
    ...
    \begin{mdframed}[style=eqbox]
        ...
        Pairs are encoded based on their frequency of occurence to achive the maxiumn compresion. The process is itteratively repeated on a vocabulary set unitl the maxiumn voc. size is reached (e.g. GPT-4 ~100k) or the algorithm runs out of pairs.\\
    \end{mdframed}
