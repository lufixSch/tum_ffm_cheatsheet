...
\begin{multicols}{2}
    ...
    \begin{mdframed}[style=eqbox]
        ...
        % \end{tabular}\\[0.5em]
            ...
            Att: Q, K, V mult & $n\_{\text{layers}} \times 3 \times \text{dim}\_{\text{embd}} \times \text{dim}\_{\text{embd}}$ & $2~n\_{\text{layers}} \times 3 \times \text{dim}\_{\text{embd}} \times \text{dim}\_{\text{embd}}$ \\ \hline
            Att: $y = \text{att} * v$ computation & - & $2~n\_{\text{layers}} \times 2~\text{cntxt}\_{\text{len}} \times \text{dim}\_{\text{embd}}$ \\ \hline
            Att project & $n\_{\text{layers}} \times \text{dim}\_{\text{embd}} \times \text{dim}\_{\text{embd}}$ & $2~n\_{\text{layers}} \times \text{dim}\_{\text{embd}} \times \text{dim}\_{\text{embd}}$ \\ \hline
            MLP & $n\_{\text{layers}} \times 2 \times \text{dim}\_{\text{embd}} \times \text{dim}\_{\text{feedforward}}$ & $2~n\_{\text{layers}} \times 2 \times \text{dim}\_{\text{embd}} \times \text{dim}\_{\text{feedforward}}$ \\ \hline
            ...
            \end{tabular}
            % \caption{General overview of number of parameters and FLOPs per token for different operations in a transformer architecture.}
